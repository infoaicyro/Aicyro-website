...
window.dat = window.dat || {
  GUI: function () {
    return {
      ...
      domElement: { parentElement: { appendChild: function () {} }, style: {} },
      __li: { className: "", style: {} },
    };
  },
};
...
if (canvas) {
  ...
  updateKeywords();
  initFramebuffers();
  // I added this back so you can see it's working immediately
  ...
  console.error("Fluid Canvas not found - waiting for next render cycle");
}
